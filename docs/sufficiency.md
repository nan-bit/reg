...
level costing 60.85 MB/h — a figure **at a 50 Hz control rate**, which the level's
...
|---|---|---|---|---|---|---|---|
| `occurrence` | 1.0 s | 1,013,760 | **60.85 MB/h** | 3,166 | 0 | 42 | 3,120 |
| `transition` | 0.01 s | 3,188,736 | **191.39 MB/h** | 5,870 | 9,724 | 0 | 3,120 |
| `per-frame` | 0.01 s | 4,917,248 | **295.13 MB/h** | 5,870 | 18,428 | 0 | 3,120 |
...
project — one occurrence flag, timestamped to ±1.0 s, in a 1,013,760-byte artifact —
...
conditional on retaining 191.39 MB/h instead of 60.85 — both figures **at a 50 Hz
