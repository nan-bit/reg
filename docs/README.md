...
| [`sufficiency.md`](sufficiency.md) | Which audit questions the artifact answers on its own authority, and which are only as strong as whatever supplied the entity positions — the tag recorded and not the basis it was computed from, until the layer basis lands. Claim 3. | **Normative for what this project may claim.** |
