...
and it is measured rather than asserted: **266 GB** per robot for six months at
the 50 Hz control loop this simulator runs at, against an assumed 1 TB/day sensor
log — roughly **686x** smaller ([`docs/retention.md`](docs/retention.md)). The
